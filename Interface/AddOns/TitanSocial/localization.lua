...
if GetLocale() == "zhCN" then
	...
	L.TOOLTIP = "社交"
	L.TOOLTIP_REALID = "在线真实ID:"
	L.TOOLTIP_FRIENDS = "在线好友:"
	L.TOOLTIP_GUILD = "在线公会成员:"

	L.MENU_REALID = "RealID"
	L.MENU_REALID_FRIENDS = "显示真实ID"
	L.MENU_REALID_BROADCASTS = "显示真实ID广播"

	L.MENU_FRIENDS = "好友"
	L.MENU_FRIENDS_SHOW = "显示好友"
	L.MENU_FRIENDS_NOTE = "显示好友备注"

	L.MENU_GUILD = "公会"
	L.MENU_GUILD_MEMBERS = "显示公会成员"
	L.MENU_GUILD_LABEL = "显示公会会阶"
	L.MENU_GUILD_NOTE = "显示公会备注"
	L.MENU_GUILD_ONOTE = "显示公会官员备注"
