...
local function CreateRollFrame()
	...
	buttonborder:SetWidth(38)
	buttonborder:SetHeight(38)
	...
	local pass, passtext = CreateRollButton(frame, "Interface\\Buttons\\UI-GroupLoot-Pass-Up", nil, "Interface\\Buttons\\UI-GroupLoot-Pass-Down", 0, PASS, "LEFT", de or greed, "RIGHT", 198, 3)
	frame.needbutt, frame.greedbutt, frame.disenchantbutt = need, greed, de
	frame.need, frame.greed, frame.pass, frame.disenchant = needtext, greedtext, passtext, detext

	local bind = frame:CreateFontString()
	bind:SetPoint("LEFT", pass, "RIGHT", -226, 1)
	bind:SetFont("Fonts\\FRIZQT__.TTF", 18, "THICKOUTLINE")
	frame.fsbind = bind
