...
function Addon:PLAYER_LOGIN()
 ...
 set = function(info, v) db[info[#info]] = v HandyNotes:SendMessage("HandyNotes_NotifyUpdate", "HandyNotes_NPCs") end,
 args = {
  desc = {
 ...
 self.button = button
 --local dropDownMenu = CreateFrame("Frame", "HandyNotes_NPCsDropDownMenu", UIParent, "UIDropDownMenuTemplate")
