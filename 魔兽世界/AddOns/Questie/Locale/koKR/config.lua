QuestieLocale.locale['koKR'] = {
    -- Config Windows
    ['OPTIONS_TAB'] = "설정",
    ['QUESTIE_HEADER'] = "Questie 설정",
    ['ENABLE_QUESTIE'] = "Questie 사용",
    ['ENABLE_QUESTIE_DESC'] = "애드온의 기능을 사용합니다.",
    ['ENABLE_ICON'] = "Questie 미니맵 아이콘 사용",
    ['ENABLE_ICON_DESC'] = "미니맵 아이콘을 사용합니다. /questie 명령어로도 설정 메뉴를 열 수 있습니다.",
