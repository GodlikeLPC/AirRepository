...
RDDB["Mists of Pandaria"] = {
	...
	-- raid instances
	[330] = { --Heart of Fear
		{ id = 330, name = "Heart of Fear", raid = true },
		["Trash"] = {
		},
	...
	[317] = { --Mogu'shan Vaults
		{ id = 317, name = "Mogu'shan Vaults", raid = true },
		["Trash"] = {
		118562, --Petrified
		116596, --Smoke Bomb
		},
	...
	[320] = { --Terrace of Endless Spring
		{ id = 320, name = "Terrace of Endless Spring", raid = true },
		["Trash"] = {
		},
		["Protector Kaolan"] = {
		order = 1, ejid = 683,
	...
	[362] = { --Throne of Thunder
		{ id = 362, name = "Throne of Thunder", raid = true },
		["Trash"] = {
		},
	...
	[369] = { --Siege of Orgrimmar
		{ id = 369, name = "Siege of Orgrimmar", raid = true },
		["Immerseus"] = {
		order = 1, ejid = 852,
