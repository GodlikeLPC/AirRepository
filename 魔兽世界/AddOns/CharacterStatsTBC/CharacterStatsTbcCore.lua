...
function CSC_SideFrame_SetArmorPenetration(statFrame, unit)
	...
	CSC_PaperDollFrame_SetLabelAndText(statFrame, ITEM_MOD_ARMOR_PENETRATION_RATING_SHORT, armorPen, false);
end
...
function CSC_SideFrame_SetSpellHastePercent(statFrame, unit)
	...
	CSC_PaperDollFrame_SetLabelAndText(statFrame, ITEM_MOD_HASTE_RATING_SHORT, hastePercent, true);
end
...
function CSC_SideFrame_SetSpellPenetration(statFrame, unit)
	...
	CSC_PaperDollFrame_SetLabelAndText(statFrame, ITEM_MOD_SPELL_PENETRATION_SHORT, spellPen, false);
end
...
function CSC_SideFrame_SetDefenseRating(statFrame, unit)
	...
	CSC_PaperDollFrame_SetLabelAndText(statFrame, COMBAT_RATING_NAME2, defenseRating, false);
end
...
function CSC_SideFrame_SetDodgeRating(statFrame, unit)
	...
	CSC_PaperDollFrame_SetLabelAndText(statFrame, ITEM_MOD_DODGE_RATING_SHORT, dodgeRating, false);
end
...
function CSC_SideFrame_SetParryRating(statFrame, unit)
	...
	CSC_PaperDollFrame_SetLabelAndText(statFrame, ITEM_MOD_PARRY_RATING_SHORT, parryRating, false);
end
...
function CSC_SideFrame_SetBlockRating(statFrame, unit)
	...
	CSC_PaperDollFrame_SetLabelAndText(statFrame, ITEM_MOD_BLOCK_RATING_SHORT, blockRating, false);
end
...
function CSC_SideFrame_SetChanceToBeCrittedBy70(statFrame, unit)
	...
	statFrame.tooltip = "被70级怪物暴击的纪律";
	CSC_PaperDollFrame_SetLabelAndText(statFrame, "被暴击", critChance70txt, false);
end
...
function CSC_SideFrame_SetChanceToBeCrittedBy73(statFrame, unit)
	...
	statFrame.tooltip = "被BOSS（73级）暴击的几率";
	CSC_PaperDollFrame_SetLabelAndText(statFrame, "被BOSS暴击", critChance73txt, false);
end
...
function CSC_SideFrame_SetAvoidance(statFrame, unit)
	...
	statFrame.tooltip = "免碾压需要的三维";
	statFrame.tooltip2 = format("需要 %.2F%% 三维 (未命中 + 躲闪 + 招架 + 格挡) 来达到免碾压 (%.2F%%).\n当前: %.F%%", avoidanceMissing, avoidanceCap, avoidanceCurrent);
	CSC_PaperDollFrame_SetLabelAndText(statFrame, "免碾三维", avoidanceMissingTxt, false);
end
...
function CSC_SideFrame_SetDefenseUncritableCap(statFrame, unit)
	...
	statFrame.tooltip = "对BOSS免暴还需要的防御等级";
	statFrame.tooltip2 = "计算防御等级和韧性";
	CSC_PaperDollFrame_SetLabelAndText(statFrame, "免暴防等", defCap73txt, false);
end
...
function CSC_SideFrame_SetResilienceUncritableCap(statFrame, unit)
	...
	statFrame.tooltip = "对BOSS免暴还需要的韧性";
	statFrame.tooltip2 = "计算防御等级和韧性";
	CSC_PaperDollFrame_SetLabelAndText(statFrame, "免暴韧性", defCap73txt, false);
end
