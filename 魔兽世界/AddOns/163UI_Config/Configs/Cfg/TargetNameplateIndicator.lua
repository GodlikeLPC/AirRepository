local function SetOptions()
    if TargetNameplateIndicator then
...
U1RegisterAddon("TargetNameplateIndicator", {
    ...
    tags = { "TAG_UNITFRAME", },
    icon = [[Interface\Addons\TargetNameplateIndicator\Textures\NeonRedArrow]],
    nopic = 1,
...

    {
        ...
        callback = function(cfg, v, loading)
            ...
            InterfaceOptionsFrame_OpenToCategory("TargetNameplateIndicator");
            InterfaceOptionsFrame_OpenToCategory("TargetNameplateIndicator");
        end
    },

    {
        ...
        var = "anim",
        default = true,
        callback = function() SetOptions() end,
    },
...

    {
        ...
        callback = function()
            ...
            for k,v in pairs(U1DBA.configs) do
