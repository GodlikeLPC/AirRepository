	...
	----------------------------------------------------------------------
	-- 	Leatrix Maps 3.0.70 (21st December 2022)
	----------------------------------------------------------------------
	...
	local function SlashFunc(str)
		...
		if str and str ~= "" then
			...
			elseif str == "admin" then
				...
				LeaMapsDB["CenterMapOnPlayer"] = "Off"
	...
	eFrame:SetScript("OnEvent", function(self, event, arg1)
		...
		if event == "ADDON_LOADED" and arg1 == "Leatrix_Maps" then
			...
			LeaMapsLC:LoadVarChk("ShowZoneMenu", "Off")					-- Show zone menu
			...
			LeaMapsLC:LoadVarChk("ShowSpiritHealers", "Off")				-- Show spirit healers
