	...
	Leatrix_Maps["Icons"] = {
		...
		--[[Tanaris]] [1446] = {
			...
			{"Dungeon", 55.6, 53.7, L["Old Hillsbrad"], L["Dungeon"], dnTex, 66, 68, 66},
			{"Dungeon", 57.4, 62.8, L["Black Morass"], L["Dungeon"], dnTex, 66, 68, 66},
			{"Dungeon", 61.4, 62.6, L["Culling of Stratholme"], L["Dungeon"], dnTex, 75, 80, 75},
			{"Raid", 57.3, 50.0, L["Hyjal Summit"], L["Raid"], rdTex, 70, 70},
		...
		--[[Zangarmarsh]] [1946] = {
			...
			{"Dungeon", 54.4, 34.6, L["Underbog"], L["Dungeon"], dnTex, 62, 70, 55},
			{"Dungeon", 48.9, 35.6, L["Slave Pens"], L["Dungeon"], dnTex, 61, 70, 55},
			{"Dungeon", 50.3, 33.3, L["Steamvault"], L["Dungeon"], dnTex, 69, 70, 65},
			{"Raid", 51.9, 33.2, L["Serpentshrine Cavern"], L["Raid"], rdTex, 70, 70},
		...
		--[[Dragonblight]] [115] = {
			...
			{"Raid", 59.6, 51.1, L["Wyrmrest Temple"],
				...
				rdTex, 80, 80},
			{"Raid", 60.0, 56.9, L["The Obsidian Sanctum"], L["Raid"], rdTex, 80, 80},
