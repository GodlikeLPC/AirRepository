-- $Id: localization.ptBR.lua 287 2017-09-19 13:28:35Z arith $ 
...
Are you sure you want to remove the following character from Accountant Classic?]=] ] = [=[O personagem selecionado será removido.
