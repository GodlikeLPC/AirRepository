-- $Id: localization.fr.lua 247 2017-05-12 17:08:38Z arith $ 
...
It has been disabled, click Okay button to reload the game.]=] ] = "Conflit détécté - \"|cFFFF0000Accountant|r\" existe et est chargé. \\n Il a été désactivé, appuez sur le bouton \"Okay\" pour /reload"
...
Are you sure you want to remove the following character from Accountant Classic?]=] ] = [=[Le personnage sélectionné va être supprimé.
Êtes-vous certain de vouloir supprimer le personnage suivant d'Accountant Classic ?]=]
...
Now click Okay button to reload the game.]=] ] = [=[Vous avez manuellement appelé la fonction
|cFF00FF00AccountantClassic_CleanUpAccountantDB()|r 
pour nettoyer les données conflictuelles existant dans "Accountant".
Cliquez sur le bouton Okay pour recharger le jeu.]=]
