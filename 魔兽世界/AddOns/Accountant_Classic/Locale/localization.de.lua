-- $Id: localization.de.lua 247 2017-05-12 17:08:38Z arith $ 
...
It has been disabled, click Okay button to reload the game.]=] ] = [=[Das konflikterzeugende Addon |cFFFF0000Accountant|r wurde entdeckt und ist gestartet.
...
Are you sure you want to remove the following character from Accountant Classic?]=] ] = [=[Der ausgewählte Charakter ist kurz davor, gelöscht zu werden.
...
Now click Okay button to reload the game.]=] ] = [=[Du hast die Funktion |cFF00FF00AccountantClassic_CleanUpAccountantDB()|r
