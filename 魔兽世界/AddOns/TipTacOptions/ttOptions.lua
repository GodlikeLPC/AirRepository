...
local options = {
	-- General
	{
		...
		{ type = "Check", var = "showStatus", label = L["Show DC, AFK and DND Status"], tip = L["Will show the <DC>, <AFK> and <DND> status after the player name"], y = 8 },
		...
		{ type = "Check", var = "showPlayerGender", label = L["Show Player Gender"], tip = L["This will show the gender of the player. E.g. \"85 Female Blood Elf Paladin\"."] },
		{ type = "DropDown", var = "nameType", label = L["Name Type"], list = { [L["Name only"]] = "normal", [L["Use player titles"]] = "title", [L["Copy from original tip"]] = "original", [L["Mary Sue Protocol"]] = "marysueprot" }, y = 16 },
		...
		{ type = "DropDown", var = "showTarget", label = L["Show Unit Target"], list = { [L["Do not show target"]] = "none", [L["First line"]] = "first", [L["Second line"]] = "second", [L["Last line"]] = "last" } },
		{ type = "Text", var = "targetYouText", label = L["Targeting You Text"], y = 16 },
	},
	-- Special
	{
		[0] = L["Special"],
		-- { type = "Check", var = "showBattlePetTip", label = L["Enable Battle Pet Tips"], tip = L["Will show a special tip for both wild and companion battle pets. Might need to be disabled for certain non-English clients"] },
		{ type = "Slider", var = "gttScale", label = L["Tooltip Scale"], min = 0.2, max = 4, step = 0.05, y = 8 },
		{ type = "Slider", var = "updateFreq", label = L["Tip Update Frequency"], min = 0, max = 5, step = 0.05 },
		{ type = "Check", var = "enableChatHoverTips", label = L["Enable ChatFrame Hover Hyperlinks"], tip = L["When hovering the mouse over a link in the chatframe, show the tooltip without having to click on it"], y = 24 },
		{ type = "Check", var = "hidePvpText", label = L["Hide PvP Text"], tip = L["Strips the PvP line from the tooltip"], y = 10 },
		{ type = "Check", var = "hideFactionText", label = L["Hide Faction Text"], tip = L["Strips the Alliance or Horde faction text from the tooltip"], x = 170 },
		{ type = "Check", var = "hideRealmText", label = L["Hide Coalesced Realm Text"], tip = L["Strips the Coalesced Realm text from the tooltip"] },
 	},
	-- Colors
	{
		[0] = L["Colors"],
		{ type = "Check", var = "colorGuildByReaction", label = L["Color Guild by Reaction"], tip = L["Guild color will have the same color as the reacion"] },
		{ type = "Color", subType = 2, var = "colGuild", label = L["Guild Color"], tip = L["Color of the guild name, when not using the option to make it the same as reaction color"], y = 8 },
		{ type = "Color", subType = 2, var = "colSameGuild", label = L["Your Guild Color"], tip = L["To better recognise players from your guild, you can configure the color of your guild name individually"], x = 120 },
		{ type = "Color", subType = 2, var = "colRace", label = L["Race & Creature Type Color"], tip = L["The color of the race and creature type text"], y = 8 },
		{ type = "Color", subType = 2, var = "colLevel", label = L["Neutral Level Color"], tip = L["Units you cannot attack will have their level text shown in this color"] },
		{ type = "Check", var = "colorNameByClass", label = L["Color Player Names by Class Color"], tip = L["With this option on, player names are colored by their class color, otherwise they will be colored by reaction"], y = 12 },
	...
	{
		[0] = L["Reactions"],
		{ type = "Check", var = "reactText", label = L["Show the unit's reaction as text"], tip = L["With this option on, the reaction of the unit will be shown as text on the last line"] },
		{ type = "Color", subType = 2, var = "colReactText0", label = L["Tapped Color"], y = 8 },
		{ type = "Color", subType = 2, var = "colReactText1", label = FACTION_STANDING_LABEL1 .. L["Unit Color"] },
		{ type = "Color", subType = 2, var = "colReactText2", label = FACTION_STANDING_LABEL2 .. L["Unit Color"] },
		{ type = "Color", subType = 2, var = "colReactText3", label = FACTION_STANDING_LABEL3 .. L["Unit Color"] },
		{ type = "Color", subType = 2, var = "colReactText4", label = FACTION_STANDING_LABEL4 .. L["Unit Color"] },
		{ type = "Color", subType = 2, var = "colReactText5", label = FACTION_STANDING_LABEL5 .. L["Unit Color"] },
		{ type = "Color", subType = 2, var = "colReactText6", label = FACTION_STANDING_LABEL6 .. L["Unit Color"] },
		{ type = "Color", subType = 2, var = "colReactText7", label = FACTION_STANDING_LABEL7 .. L["Unit Color"] },
		{ type = "Color", subType = 2, var = "colReactText8", label = FACTION_STANDING_LABEL8 .. L["Unit Color"] },
		{ type = "Color", subType = 2, var = "colReactText9", label = L["Friendly Player Color"] },
		{ type = "Color", subType = 2, var = "colReactText10", label = L["Dead Color"] },
	},
	-- BG Color
	{
		[0] = L["BG Color"],
		...
		{ type = "Color", var = "colReactBack0", label = L["Tapped Color"], y = 8 },
		{ type = "Color", var = "colReactBack1", label = FACTION_STANDING_LABEL1 .. L["Unit Color"] },
		{ type = "Color", var = "colReactBack2", label = FACTION_STANDING_LABEL2 .. L["Unit Color"] },
		{ type = "Color", var = "colReactBack3", label = FACTION_STANDING_LABEL3 .. L["Unit Color"] },
		{ type = "Color", var = "colReactBack4", label = FACTION_STANDING_LABEL4 .. L["Unit Color"] },
		{ type = "Color", var = "colReactBack5", label = FACTION_STANDING_LABEL5 .. L["Unit Color"] },
		{ type = "Color", var = "colReactBack6", label = FACTION_STANDING_LABEL6 .. L["Unit Color"] },
		{ type = "Color", var = "colReactBack7", label = FACTION_STANDING_LABEL7 .. L["Unit Color"] },
		{ type = "Color", var = "colReactBack8", label = FACTION_STANDING_LABEL8 .. L["Unit Color"] },
		{ type = "Color", var = "colReactBack9", label = L["Friendly Player Color"] },
		{ type = "Color", var = "colReactBack10", label = L["Dead Color"] },
	},
	-- Backdrop
	{
		[0] = L["Backdrop"],
		{ type = "DropDown", var = "tipBackdropBG", label = L["Background Texture"], media = "background" },
		{ type = "DropDown", var = "tipBackdropEdge", label = L["Border Texture"], media = "border" },
		{ type = "Slider", var = "backdropEdgeSize", label = L["Backdrop Edge Size"], min = -20, max = 64, step = 0.5, y = 8 },
		{ type = "Slider", var = "backdropInsets", label = L["Backdrop Insets"], min = -20, max = 20, step = 0.5 },
		{ type = "Color", var = "tipColor", label = L["Tip Background Color"], y = 18 },
		{ type = "Color", var = "tipBorderColor", label = L["Tip Border Color"], x = 160 },
		...
		{ type = "Color", var = "gradientColor", label = L["Gradient Color"], tip = L["Select the base color for the gradient"], x = 160 },
	},
	-- Font
	{
		[0] = L["Font"],
		...
		{ type = "DropDown", var = "fontFace", label = L["Font Face"], media = "font", y = 32 },
		{ type = "DropDown", var = "fontFlags", label = L["Font Flags"], list = DROPDOWN_FONTFLAGS },
		{ type = "Slider", var = "fontSize", label = L["Font Size"], min = 6, max = 29, step = 1, y = 4 },
		{ type = "Slider", var = "fontSizeDeltaHeader", label = L["Font Size Header Delta"], min = -10, max = 10, step = 1, y = 20 },
		{ type = "Slider", var = "fontSizeDeltaSmall", label = L["Font Size Small Delta"], min = -10, max = 10, step = 1 },
	},
	-- Classify
	{
		[0] = L["Classify"],
	...
	{
		[0] = L["Fading"],
		{ type = "Check", var = "overrideFade", label = L["Override Default GameTooltip Fade"], tip = L["Overrides the default fadeout function of the GameTooltip. If you are seeing problems regarding fadeout, please disable."] },
		{ type = "Slider", var = "preFadeTime", label = L["Prefade Time"], min = 0, max = 5, step = 0.05, y = 16 },
		{ type = "Slider", var = "fadeTime", label = L["Fadeout Time"], min = 0, max = 5, step = 0.05 },
	...
	-- Bars
	{
		...
		{ type = "Slider", var = "barFontSize", label = L["Font Size"], min = 6, max = 29, step = 1 },
		{ type = "DropDown", var = "barTexture", label = L["Bar Texture"], media = "statusbar", y = 36 },
	...
	-- Bar Types
	{
		...
		{ type = "Check", var = "healthBar", label = L["Show Health Bar"], tip = L["Will show a health bar of the unit."], y = 12 },
		{ type = "DropDown", var = "healthBarText", label = L["Health Bar Text"], list = DROPDOWN_BARTEXTFORMAT },
		{ type = "Color", var = "healthBarColor", label = L["Health Bar Color"], tip = L["The color of the health bar. Has no effect for players with the option above enabled"] },
		{ type = "Check", var = "healthBarClassColor", label = L["Class Colored Health Bar"], tip = L["This options colors the health bar in the same color as the player class"], x = 130 },
		{ type = "Check", var = "manaBar", label = L["Show Mana Bar"], tip = L["If the unit has mana, a mana bar will be shown."], y = 12 },
		{ type = "DropDown", var = "manaBarText", label = L["Mana Bar Text"], list = DROPDOWN_BARTEXTFORMAT },
		{ type = "Color", var = "manaBarColor", label = L["Mana Bar Color"], tip = L["The color of the mana bar"] },
		{ type = "Check", var = "powerBar", label = L["Show Energy, Rage, Runic Power or Focus Bar"], tip = L["If the unit uses either energy, rage, runic power or focus, a bar for that will be shown."], y = 12 },
		{ type = "DropDown", var = "powerBarText", label = L["Power Bar Text"], list = DROPDOWN_BARTEXTFORMAT },
	},
	-- Auras
	{
		[0] = L["Auras"],
		{ type = "Check", var = "aurasAtBottom", label = L["Put Aura Icons at the Bottom Instead of Top"], tip = L["Puts the aura icons at the bottom of the tip instead of the default top"] },
		{ type = "Check", var = "showBuffs", label = L["Show Unit Buffs"], tip = L["Show buffs of the unit"], y = 12 },
		{ type = "Check", var = "showDebuffs", label = L["Show Unit Debuffs"], tip = L["Show debuffs of the unit"] },
		...
		{ type = "Slider", var = "auraSize", label = L["Aura Icon Dimension"], min = 8, max = 60, step = 1, y = 12 },
		{ type = "Slider", var = "auraMaxRows", label = L["Max Aura Rows"], min = 1, max = 8, step = 1 },
		{ type = "Check", var = "showAuraCooldown", label = L["Show Cooldown Models"], tip = L["With this option on, you will see a visual progress of the time left on the buff"], y = 8 },
	...
	-- Icon
	{
		...
		{ type = "Check", var = "iconClass", label = L["Show Class Icon"], tip = L["For players, this will display the class icon next to the tooltip"] },
		{ type = "DropDown", var = "iconAnchor", label = L["Icon Anchor"], list = DROPDOWN_ANCHORPOS, y = 12 },
		{ type = "Slider", var = "iconSize", label = L["Icon Dimension"], min = 8, max = 100, step = 1 },
	},
	-- Anchors
	{
		[0] = L["Anchors"],
		{ type = "Check", var = "anchorInCombat", label = L["Default anchor in Combat"] },
		{ type = "DropDown", var = "anchorWorldUnitType", label = L["World Unit Type"], list = DROPDOWN_ANCHORTYPE },
		{ type = "DropDown", var = "anchorWorldUnitPoint", label = L["World Unit Point"], list = DROPDOWN_ANCHORPOS },
		{ type = "DropDown", var = "anchorWorldTipType", label = L["World Tip Type"], list = DROPDOWN_ANCHORTYPE, y = 14 },
		{ type = "DropDown", var = "anchorWorldTipPoint", label = L["World Tip Point"], list = DROPDOWN_ANCHORPOS },
		{ type = "DropDown", var = "anchorFrameUnitType", label = L["Frame Unit Type"], list = DROPDOWN_ANCHORTYPE, y = 14 },
		{ type = "DropDown", var = "anchorFrameUnitPoint", label = L["Frame Unit Point"], list = DROPDOWN_ANCHORPOS },
		{ type = "DropDown", var = "anchorFrameTipType", label = L["Frame Tip Type"], list = DROPDOWN_ANCHORTYPE, y = 14 },
		{ type = "DropDown", var = "anchorFrameTipPoint", label = L["Frame Tip Point"], list = DROPDOWN_ANCHORPOS },
	},
	-- Mouse
	{
		[0] = L["Mouse"],
	...
	-- Combat
	{
		...
		{ type = "Check", var = "hideUFTipsInCombat", label = L["Hide Unit Tips for Unit Frames in Combat"], tip = L["When you are in combat, this option will prevent tips from showing when you have the mouse over a unit frame"] },
		{ type = "Check", var = "showHiddenTipsOnShift", label = L["Still Show Hidden Tips when Holding Shift"], tip = L["When you have this option checked, and one of the above options, you can still force the tip to show, by holding down shift"], y = 8 },
--		{ type = "DropDown", var = "hideCombatTip", label = L["Hide Tips in Combat For"], list = { [L["Unit Frames"]] = "uf", [L["All Tips"]] = "all", [L["No Tips"]] = "none" } },
	},
	-- Layouts
	{
		[0] = L["Layouts"],
		{ type = "DropDown", label = L["Layout Template"], init = TipTacLayouts.LoadLayout_Init },
--		{ type = "Text", label = L["Save Layout"], func = nil },
--		{ type = "DropDown", label = L["Delete Layout"], init = TipTacLayouts.DeleteLayout_Init },
	},
};
...
if (TipTacTalents) then
	options[#options + 1] = {
		...
		{ type = "Check", var = "talentOnlyInParty", label = L["Only Show Talents for Party and Raid Members"], tip = L["When you enable this, only talents of players in your party or raid will be requested and shown"] },
--		{ type = "DropDown", var = "talentFormat", label = L["Talent Format"], list = { [L["Elemental (57/14/00)"]] = 1, [L["Elemental"]] = 2, [L["57/14/00"]] = 3,}, y = 8 },	-- not supported with MoP changes
		{ type = "Slider", var = "talentCacheSize", label = L["Talent Cache Size"], min = 0, max = 50, step = 1, y = 12 },
	};
end
...
if (TipTacItemRef) then
	options[#options + 1] = {
		[0] = L["ItemRef"],
		{ type = "Check", var = "if_enable", label = L["Enable ItemRefTooltip Modifications"], tip = L["Turns on or off all features of the TipTacItemRef addon"] },
		{ type = "Color", var = "if_infoColor", label = L["Information Color"], tip = L["The color of the various tooltip lines added by these options"], y = 8 },
		...
		{ type = "Check", var = "if_showItemLevel", label = L["Show Item Level"], tip = L["For item tooltips, show their itemLevel (Combines with itemID). This will remove the default itemLevel text shown in tooltips"] },
		{ type = "Check", var = "if_showItemId", label = L["Show Item ID"], tip = L["For item tooltips, show their itemID (Combines with itemLevel)"], x = 160 },
