...
L["EarthShieldOptionsDesc"] = "Si 'relance' est sélectionné comme option par un bouton de la souris, le bouclier est jeté sur la dernière personne qui fut hors de combat. Utilisation par défaut: Sélection de votre cible pour le BT et lancer le sort avec le bouton droit. Ensuite, vous pouvez cibler quelqu'un d'autre, mais le BT sera encore lancé sur la même personne bouton gauche, même combat."
