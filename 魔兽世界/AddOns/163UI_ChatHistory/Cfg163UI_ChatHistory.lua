...
--[[
    ...
    },
    {
        ...
        callback = function(cfg, v, loading)
            if loading then
                _Store["U1ChatHistory_HookAddHistoryLine"] = _G["U1ChatHistory_HookAddHistoryLine"];
            else
                if v then
                    _G["U1ChatHistory_HookAddHistoryLine"] = _Store["U1ChatHistory_HookAddHistoryLine"];
                elseif _Store["U1ChatHistory_HookAddHistoryLine"] then
                    _G["U1ChatHistory_HookAddHistoryLine"] = noop;
                end
            end
        end,
    },
