...
--L.GUILD_COMBAT_STARTED		= "%s a été engagé par la guilde"--Uncomment when updated, args have changed
...
--L.GUILD_BOSS_DOWN			= "%s a été vaincu par la guilde en %s!"--Uncomment when updated, args have changed
...
--L.GUILD_COMBAT_ENDED_AT		= "La guilde a wipe sur %s (%s) après %s."--Uncomment when updated, args have changed
