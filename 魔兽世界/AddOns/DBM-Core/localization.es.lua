...
--L.GUILD_COMBAT_STARTED		= "Tu hermandad ha iniciado el encuentro de %s."--Uncomment when updated, args have changed
...
--L.GUILD_BOSS_DOWN			= "¡%s ha sido derrotado por tu hermandad en %s!"--Uncomment when updated, args have changed
...
--L.GUILD_COMBAT_ENDED_AT		= "Tu hermandad ha sido derrotada en el encuentro de %s (%s) en %s."--Uncomment when updated, args have changed
