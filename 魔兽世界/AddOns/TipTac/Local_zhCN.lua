...
L["Show Who Targets the Unit"] = "显示目标的目标";
...
L["Tip Update Frequency"] = "鼠标提示刷新频率";
L["Enable ChatFrame Hover Hyperlinks"] = "启用聊天框悬停超链接显示提示信息";
L["Hide PvP Text"] = "隐藏PVP文本";
L["Strips the PvP line from the tooltip"] = "隐藏PVP文本";
...
-- Colors		
L["Colors"] = "颜色";
L["Color Guild by Reaction"] = "按反应来着色公会";
...
L["Race & Creature Type Color"] = "种族和生物类型颜色";
...
L["Color Player Names by Class Color"] = "按职业颜色着色玩家姓名";
...
L["Color Tip Border by Class Color"] = "按职业颜色着色提示边框";
...
-- Reactions		
L["Reactions"] = "声望等级";
L["Show the unit's reaction as text"] = "以文本形式显示单位声望等级";
L["With this option on, the reaction of the unit will be shown as text on the last line"] = "当此选项开启, 单位声望等级将以文本形式显示在末行";
L["Unit Color"] = "单位颜色";
L["Tapped Color"] = "已被其他玩家接触了的单位颜色";
L["Friendly Player Color"] = "友好玩家单位颜色";
L["Dead Color"] = "死亡单位颜色";
-- BG Color		
L["BG Color"] = "背景颜色";
L["Color backdrop based on the unit's reaction"] = "基于单位声望等级着色背景";
...
L["Color border based on the unit's reaction"] = "基于单位声望等级着色边框";
...
L["Backdrop Insets"] = "边框收缩尺寸";
L["Tip Background Color"] = "背景颜色";
L["Tip Border Color"] = "边框颜色";
...
L["Font Size Header Delta"] = "标题字体尺寸变化";
L["Font Size Small Delta"] = "小字体尺寸变化";
-- Classify		
L["Classify"] = "分类";
L["Minus"] = "负面";
L["Trivial"] = "小喽囉";
...
L["Puts the aura icons at the bottom of the tip instead of the default top"] = "光环图标放在底部";
L["Show Unit Buffs"] = "显示Buffs";
L["Show buffs of the unit"] = "显示单位的增益效果";
L["Show Unit Debuffs"] = "显示Debuffs";
...
-- Anchors		
L["Anchors"] = "锚点";
L["Default anchor in Combat"] = "战斗中不移动"
...
-- Mouse		
L["Mouse"] = "鼠标";
L["Mouse Anchor X Offset"] = "鼠标锚点横向X偏移";
L["Mouse Anchor Y Offset"] = "鼠标锚点纵向Y偏移";
-- Combat		
L["Combat"] = "战斗";
L["Hide All Unit Tips in Combat"] = "战斗时隐藏所有鼠标提示";
L["In combat, this option will prevent any unit tips from showing"] = "在战斗中, 此选项将阻止任何单位提示显示";
L["Hide Unit Tips for Unit Frames in Combat"] = "战斗时隐藏单位框体的鼠标提示";
...
L["Still Show Hidden Tips when Holding Shift"] = "按住Shift时始终显示隐藏的提示";
...
L["ItemRef"] = "物品信息";
L["Enable ItemRefTooltip Modifications"] = "启用ItemRefTooltip增强";
...
L["Show Item Tips with Quality Colored Border"] = "按物品品质颜色对边框进行着色";
...
L["Show Aura Tooltip Caster"] = "显示施法者";
...
L["For item tooltips, show their itemLevel (Combines with itemID). This will remove the default itemLevel text shown in tooltips"] = "对于物品提示信息, 显示它们的物品等级";
L["For item tooltips, show their itemID (Combines with itemLevel)"] = "对于物品提示信息, 显示它们的物品ID";
L["Show Spell ID & Rank"] = "显示法术ID和等级";
L["For spell and aura tooltips, show their spellID and spellRank"] = "对于法术和状态提示信息, 显示它们的法术ID及法术等级";
-- L["Show Currency ID"] = "显示货币ID";
-- L["Currency items will now show their ID"] = "货币物品现在将显示其ID";
-- L["Show Achievement ID & Category"] = "显示成就ID & 分类";
-- L["On achievement tooltips, the achievement ID as well as the category will be shown"] = "在成就提示信息上, 成就ID将和分类一起显示";
L["Show Quest Level & ID"] = "显示任务等级和ID";
L["For quest tooltips, show their questLevel and questID"] = "对于任务提示信息, 显示它们的任务等级及任务ID";
