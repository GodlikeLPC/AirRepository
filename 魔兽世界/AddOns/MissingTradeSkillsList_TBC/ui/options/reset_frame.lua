...
MTSLOPTUI_RESET_FRAME = {
    ...
    Initialise = function (self, parent_frame)
        ...
        self.ui_frame.realm_drop_down = UIDD:Create_UIDropDownMenu("MTSLOPTUI_RESET_FRAME_DD_REALM", self.ui_frame)
        ...
        UIDD:UIDropDownMenu_SetWidth(self.ui_frame.realm_drop_down, 150)
        UIDD:UIDropDownMenu_SetText(self.ui_frame.realm_drop_down, self.current_realm)
        ...
        self.ui_frame.player_drop_down = UIDD:Create_UIDropDownMenu("MTSLOPTUI_RESET_FRAME_DD_PLAYER", self.ui_frame)
        ...
        UIDD:UIDropDownMenu_SetWidth(self.ui_frame.player_drop_down, 150)
        UIDD:UIDropDownMenu_SetText(self.ui_frame.player_drop_down, self.current_player)
            ...
            if MTSLOPTUI_RESET_FRAME.current_realm ~= nil and MTSLOPTUI_RESET_FRAME.current_player ~= nil then
                ...
                if MTSL_LOGIC_SAVED_VARIABLES:RemoveCharacter(MTSLOPTUI_RESET_FRAME.current_player, MTSLOPTUI_RESET_FRAME.current_realm) then
                    ...
                    if MTSLOPTUI_RESET_FRAME.current_realm ~= nil then
                        UIDD:UIDropDownMenu_SetText(MTSLOPTUI_RESET_FRAME.ui_frame.realm_drop_down, MTSLOPTUI_RESET_FRAME.current_realm)
                        -- Rebuild player dropdown
                        MTSLOPTUI_RESET_FRAME:CreateDropDownPlayersOnRealm(1)
                        UIDD:UIDropDownMenu_SetText(MTSLOPTUI_RESET_FRAME.ui_frame.player_drop_down, MTSLOPTUI_RESET_FRAME.current_player)
                    else
                        UIDD:UIDropDownMenu_SetText(MTSLOPTUI_RESET_FRAME.ui_frame.realm_drop_down, "")
                        UIDD:UIDropDownMenu_SetText(MTSLOPTUI_RESET_FRAME.ui_frame.player_drop_down, "")
                    end
                end
            end
        end)
    ...
    ChangeRealm = function(self, realm_id, realm_name)
        ...
        UIDD:UIDropDownMenu_SetText(self.ui_frame.realm_drop_down, realm_name)
    ...
    ChangePlayer = function(self, value, text)
        ...
        UIDD:UIDropDownMenu_SetText(self.ui_frame.player_drop_down, text)
    end,
