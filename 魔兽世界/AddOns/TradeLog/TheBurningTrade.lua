...
TBT_PORTAL_MAPPING = {
	[TBT_PORTAL_1]="Interface\\AddOns\\TradeLog\\icons\\9.tga",
	[TBT_PORTAL_2]="Interface\\AddOns\\TradeLog\\icons\\11.tga",
	[TBT_PORTAL_3]="Interface\\AddOns\\TradeLog\\icons\\4.tga",
	[TBT_PORTAL_4]="Interface\\AddOns\\TradeLog\\icons\\5.tga",
	[TBT_PORTAL_5]="Interface\\AddOns\\TradeLog\\icons\\6.tga",
	[TBT_PORTAL_6]="Interface\\AddOns\\TradeLog\\icons\\8.tga",
	[TBT_PORTAL_7]="Interface\\AddOns\\TradeLog\\icons\\10.tga",
	[TBT_PORTAL_8]="Interface\\AddOns\\TradeLog\\icons\\13.tga",
	[TBT_PORTAL_9]="Interface\\AddOns\\TradeLog\\icons\\3.tga",
	[TBT_PORTAL_10]="Interface\\AddOns\\TradeLog\\icons\\12.tga",
	[TBT_PORTAL_11]="Interface\\AddOns\\TradeLog\\icons\\7.tga",
	[TBT_PORTAL_12]="Interface\\AddOns\\TradeLog\\icons\\2.tga",
}
...
function TBTFrame_OnPlayerEnter()
	...
	if(TBT_MaxSpellRank==nil) then
		...
		local i = 1
		local spellName, spellIcon,id;
		while true do
			spellName, spellIcon,id =nil,nil,nil;
			local function f()
				spellName, _,spellIcon,_,_,_,id= GetSpellInfo(i, BOOKTYPE_SPELL);
			end
			pcall(f);
			...
			if(class=="MAGE")then
				...
				UpdateMaxRank("water", id);
				UpdateMaxRank("food", id);
			elseif(class=="WARLOCK")then
				UpdateMaxRank("stone", id);
			end
			i = i + 1
		end
		if(class=="MAGE")then
...
local ids = {
	water = { 5504, 5505, 5506, 6217, 10138, 10139, 10140, },
	food = { 587, 597, 990, 6129, 10144, 10145, 28612,},
	stone = { 6201, 6202, 5699, 11729, 11730, },
}
function UpdateMaxRank(type, id)
	local spells = ids[type];
	local j;
	for j = 1, #spells do
		if spells[j] == id then
