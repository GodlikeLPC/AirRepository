...
TBT_SPELL_TABLE = {
	...
	stone = {
		{ name="製造治療石", level=0,  item="初級治療石" },
		{ name="製造治療石", level=12, item="次級治療石" },
		{ name="製造治療石", level=24, item="治療石" },
		{ name="製造治療石", level=36, item="強效治療石" },
		{ name="製造治療石", level=48, item="極效治療石" },
		{ name="製造治療石", level=60, item="極強效治療石" },
	}
}
