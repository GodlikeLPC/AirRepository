...
function TradeLogFrame_UpdateItemDetail(frame, name, texture, numItems, isUsable, enchantment, itemLink)
	...
	SetItemButtonQuality(tradeItemButton, itemLink and select(3, GetItemInfo(itemLink)));
...
StaticPopupDialogs["TRADE_LIST_CLEAR_HISTORY"] = {
	text = "CLEAR TRADE HISTORY",
	button1 = ACCEPT,
	button2 = CANCEL,
	whileDead = 1,
	text = TRADE_LIST_CLEAR_CONFIRM,
