...
if not L then
    T._LoadedFiles["ruRU.lua"] = "2.7.8.12";
    return;
end;
...
L["OPT_ENABLE_LIVELIST_DESC"] = "Отображает информативный список пораженных людей. Вы можете перемещать этот список, перемещая панель Decursive (введите /DCRSHOW, чтобы отобразить эту панель)."
