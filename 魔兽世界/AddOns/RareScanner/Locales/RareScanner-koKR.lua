...
if AL then
	...
	AL["CMD_HELP1"] = "명령어 목록"
	AL["CMD_HELP10"] = "세계 지도 표식 검색 활성화/비활성화"
	...
	AL["DISABLED_SEARCHING_CONTAINER"] = "이 상자에 대해 비활성화 된 경고: %s"
	...
	AL["MAP_TOOLTIP_CONTAINER_NOT_LOOTED"] = "Alt-Shift-좌-클릭하여 닫힌 상태로 설정"
	AL["MAP_TOOLTIP_DAYS"] = "일"
	AL["MAP_TOOLTIP_EVENT_DONE"] = "완료로 설정하려면 Alt+Shift+좌클릭"
	AL["MAP_TOOLTIP_EVENT_NOT_DONE"] = "완료되지 않은 것으로 설정하려면 Alt-Shift-좌-클릭"
	AL["MAP_TOOLTIP_KILLED"] = "사망으로 설정하려면 Alt+Shift+좌클릭"
	AL["MAP_TOOLTIP_NOT_FOUND"] = "이 NPC를 아직 보지 못했습니다."
	AL["MAP_TOOLTIP_NOT_KILLED"] = "Alt-Shift-좌-클릭하여 활성으로 설정"
