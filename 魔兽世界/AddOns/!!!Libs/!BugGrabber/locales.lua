...
L["ADDON_DISABLED"] = "|cffffff00!BugGrabber и %s не могут работать вместе. Поэтому %s была отключена. Если хотите, то можете выйти из игрового мира, отключить !BugGrabber и включить %s.|r"
