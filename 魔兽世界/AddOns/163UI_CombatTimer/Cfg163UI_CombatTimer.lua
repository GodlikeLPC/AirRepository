U1RegisterAddon("163UI_CombatTimer", {
    ...
    toggle = function(name, info, enable, justload)
        if enable then
            ...
            U1CT:SetShown(U1GetCfgValue(name, "timer"));
        else
...

    {
...

        {
            ...
            type = "drop",
            options = {
                "女声开火", 539383,--"Sound\\Character\\BloodElf\\BloodElfFemaleOpenFire01.ogg",
                "哐", 567513,--"Sound\\Interface\\LFG_RoleCheck.ogg",
                "嘭", 567471,--"Sound\\Interface\\Aggro_Pulled_Aggro.ogg",
...

        {
            ...
            callback = function(cfg, v, loading)
                ...
                if not loading and not InCombatLockdown() then
                    ...
                    CoreScheduleBucket("U1CT_CFG_STOP", 5.0, U1CT.StartTimer, false)
                end
            end,
        },
    }
