...
local function ElvSkinFrames()
	...
	local function LoadSkin()
		for i = 1, QUESTS_DISPLAYED do
			local questLogTitle = _G['QuestLogListScrollFrameButton'..i]
...
local function SkinFrames()
    ...
    for i = oldQuestsDisplayed + 1, QUESTS_DISPLAYED do
        local button = CreateFrame("Button", "QuestLogListScrollFrameButton" .. i, QuestLogFrame, "QuestLogTitleButtonTemplate");
        button:SetID(i);
        button:Hide();
        button:ClearAllPoints();
        button:SetPoint("TOPLEFT", _G["QuestLogListScrollFrameButton" .. (i - 1)], "BOTTOMLEFT", 0, 1);
    end
