...
L["[Show/Hide] The PallyPower Tooltips"] = "PallyPower 툴팁 [표시/숨김]"
...
L["Reset all PallyPower frames back to center"] = "모든 PallyPower 프레임을 중앙으로 초기화"
...
L["This allows you to adjust the overall size of the PallyPower Buttons"] = "이것으로 PallyPower 버튼의 전체 크기를 조정할 수 있습니다."
...
L["What to buff with PallyPower"] = "PallyPower로 버프할 내용"
--[[Translation missing --]]
