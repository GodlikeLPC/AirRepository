    ...
    return {
        ...
        args = {
            ...
            Version = {
                ...
                guiHidden = true,
                func = function () HHTD:Print(L["VERSION"], '2.4.9.14,', L["RELEASE_DATE"], '2022-11-28T00:44:14Z') end,
                order = -5,
            },
            ShowGUI = {
                type = 'execute',
            ...
            core = {
                ...
                args = {
                    Info_Header = {
                        type = 'header',
                        name = L["VERSION"] .. ' 2.4.9.14 -- ' .. L["RELEASE_DATE"] .. ' 2022-11-28T00:44:14Z',
                        order = 1,
                    },
                    Pve = {
                        type = 'toggle',
