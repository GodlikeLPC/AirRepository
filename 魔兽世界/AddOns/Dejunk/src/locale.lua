...
L["COMMANDS"] = "Commands"
L["CTRL_ALT_RIGHT_CLICK"] = "Ctrl+Alt Right-Click"
...
L["JUNK_FRAME_TOOLTIP"] = "Junk items you currently possess will be listed in this frame.|n|nTo add an item to %s, drop it into the frame below."
...
L["TOGGLE_TRANSPORT_FRAME"] = "Toggle Transport Frame"
...
L["AUTO_JUNK_FRAME_TOOLTIP"] = "Автоматически переключайте окно «Хлам» при взаимодействии с торговцем или переключении ваших сумок."
...
L["COMMANDS"] = "Команды"
L["CTRL_ALT_RIGHT_CLICK"] = "Ctrl+Alt ПКМ"
...
L["TOGGLE_TRANSPORT_FRAME"] = "Включить окно переноса"
...
L["AUTO_JUNK_FRAME_TOOLTIP"] = "当与商贩交互时，自动切换垃圾框架或背包。"
...
L["COMMANDS"] = "指令"
L["CTRL_ALT_RIGHT_CLICK"] = "Ctrl+Alt+右键"
L["DESTROY"] = "摧毁"
...
L["JUNK_FRAME_TOOLTIP"] = "你当前拥有的垃圾物品会被列在此框架内。|n|n若要添加物品到%s，将其拖放到下方框架。"
L["JUNK_ITEMS"] = "垃圾物品"
L["KEYBINDS"] = "按键绑定"
L["LEFT_CLICK"] = "点击左键"
...
L["COMMANDS"] = "指令"
L["CTRL_ALT_RIGHT_CLICK"] = "Ctrl+Alt 右鍵點擊"
