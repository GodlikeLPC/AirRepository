...
LibItemStatsPatterns = {
	...
	extra = {
        ...
        { key = "Resilience", pattern = "提高(%d+)點韌性" },
		{ key = "SpellHitRating", pattern = "提高法術命中等級(%d+)" },
        { key = "SpellHitRating", pattern = "提高(%d+)點法術命中" },
		{ key = "HasteSpell", pattern = "提高法術加速等級(%d+)" },
		{ key = "SpellCrit", pattern = "提高法術致命一擊等級(%d+)" },
        { key = "SpellCrit", pattern = "提高(%d+)點法術致命一擊" },
		{ key = "SpellStrike", pattern = "法術穿透力提高(%d+)" },		
		{ key = "SpellDamage|Healing", pattern = "所有法術和魔法效果所造成的傷害和治療效果.-最多(%d+)" },
		{ key = "SpellDamage|Healing", pattern = "所有法術和魔法效果所造成的傷害和治療效果.-最多(%d+)" },
        { key = "SpellDamage|Healing", pattern = "法術和魔法效果所造成的傷害和治療效果.-最多(%d+)" },
		{ key = "Healing", pattern = "法術和魔法效果所造成的治療效果.-最多(%d+)" },
		{ key = "DamageFrost", pattern = "冰霜法術和效果所造成的傷害.-最多(%d+)" },
		{ key = "DamageShadow", pattern = "暗影法術和效果所造成的傷害.-最多(%d+)" },
		{ key = "DamageArcane", pattern = "祕法法術和效果所造成的傷害.-最多(%d+)" },
		{ key = "DamageFire", pattern = "火焰法術和效果所造成的傷害.-最多(%d+)" },
		{ key = "DamageNature", pattern = "自然法術和效果所造成的傷害.-最多(%d+)" },
		{ key = "DamageHoly", pattern = "神聖法術和效果所造成的傷害.-最多(%d+)" },
		...
		{ key = "SpellCrit", pattern = "法術造成致命一擊.-提高(%d+)" },
    ...
    buff = {
		...
		{ key = "ResistanceFrost|ResistanceShadow|ResistanceArcane|ResistanceFire|ResistanceNature|ResistanceHoly", pattern = "所有抗性提高(%d+)點", conflict = true },
		{ key = "ManaRestore", pattern = "每5秒恢復(%d+)點法力"},
		...
		{ key = "SpellDamage", pattern = "法術傷害和治療效果.-最多(%d+)"},
