...
local function createButtons(titleButton, questNotGossip)
    ...
    titleButton.btnAccept:SetNormalFontObject(DialogButtonNormalText);
    titleButton.btnAccept:SetHighlightFontObject(DialogButtonHighlightText);
    ...
    titleButton.btnComplete:SetNormalFontObject(DialogButtonNormalText);
    titleButton.btnComplete:SetHighlightFontObject(DialogButtonHighlightText);
end
    ...
    for i=1, NUMGOSSIPBUTTONS do
        ...
        if titleButton:IsShown() then
            if titleButton.type == "Active" then
                ...
                --temporary fix. titleButtonIcon:GetTexture() = table or integer
                if type(titleButtonIcon:GetTexture()) == "table" and titleButtonIcon:GetTexture():find("Incomplete") then
