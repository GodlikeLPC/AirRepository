if not LibStub('AceAddon-3.0', true) or not LibStub('AceTimer-3.0', true) or not LibStub('AceEvent-3.0', true) then return end
...
function PingPing:OnInitialize()
    self.f = CreateFrame('Frame', '163UIMinimapPingFrame', UIParent, "BackdropTemplate")
