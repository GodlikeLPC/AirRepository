...
local localToMap = {}
local idToMap = {}
local GetPlayerFacing, GetPlayerMapPosition,SetMapToCurrentZone = GetPlayerFacing, C_Map.GetPlayerMapPositionCM, SetMapToCurrentZone
	...
	for k,v in pairs(mapData) do
		...
		if v.floors > 0 and floors > 0 then
			for f = 1, floors do
				...
				local _, l, t, r, b = LuaUtils.DGV.GetCurrentMapDungeonLevel()
...
-- @usage local w,h = lib:MapArea(GetMapInfo(),LuaUtils.DGV.GetCurrentMapDungeonLevel())
...
-- @usage local x,y = lib:MapUpperLeft(GetMapInfo(),LuaUtils.DGV.GetCurrentMapDungeonLevel())
...
-- @usage local x,y = lib:MapLowerRight(GetMapInfo(),LuaUtils.DGV.GetCurrentMapDungeonLevel())
...
function lib:ZoneChanged(force)
	...
	local floor = LuaUtils.DGV.GetCurrentMapDungeonLevel()
