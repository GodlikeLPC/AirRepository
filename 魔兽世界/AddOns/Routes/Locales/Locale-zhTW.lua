...
L["Are you sure you want to recreate this route? This will delete all customized settings for this route."] = "你確定你要重建這條路線嗎?這會刪除所有你對這條路線的自訂設定"
...
L["Recreate Route"] = "重建路線"
L["Recreate this route with the same creation settings. NOTE: This only works for data from GatherMate2 and Gatherer."] = "使用同樣的設定重建這條路線. 注意:這僅可使用在資料來源為 GatherMate2 或是 Gatherer"
L["Reset"] = "重置"
...
L["Routes with Archaeology"] = "考古路線"
