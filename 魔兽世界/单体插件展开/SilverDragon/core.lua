...
do
	...
	local debuggable = GetAddOnMetadata(myname, "Version") == 'v4.0.18c'
	local _window
...
_G["BINDING_NAME_CLICK SilverDragonPopupButton:LeftButton"] = "目标最近找到的稀有"
_G["BINDING_NAME_CLICK SilverDragonMacroButton:LeftButton"] = "扫描附近的怪物"
